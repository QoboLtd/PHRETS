...
class ResponseTest extends TestCase
{
    ...
    {
        $body = "<?xml version='1.0' encoding='UTF-8'?><guestbook><guest><fname>First Name</fname>" .
            "<lname>Last Name</lname></guest></guestbook>";
    ...
    {
        $body = "\n\n\r<?xml version='1.0' encoding='UTF-8'?><guestbook><guest><fname>First Name</fname>" .
            "<lname>Last Name</lname></guest></guestbook>\r\n\n";
        $guzzleResponse = new \GuzzleHttp\Psr7\Response(200, ['X-Foo' => 'Bar'], $body);
