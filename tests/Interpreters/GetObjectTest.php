...
class GetObjectTest extends TestCase
{
    ...
    {
        self::assertEquals(['12345:1'], GetObject::ids(12345, 1));
    }

    #[Test]
    public function itCombinesMultipleFromString(): void
    {
        self::assertEquals(['12345:1', '67890:1'], GetObject::ids('12345,67890', 1));
    }
    ...
    {
        self::assertEquals(['12345:1:2:3', '67890:1:2:3'], GetObject::ids([12345, 67890], '1,2,3'));
    }
    ...
    {
        self::assertEquals(['12345:1:2:3:4:5', '67890:1:2:3:4:5'], GetObject::ids([12345, 67890], '1-5'));
    }
}
